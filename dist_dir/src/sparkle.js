...
//VARIABLES I ADDED
var cIndex = 0;
var colors = ['#ff0000','#00ff00','#ffffff','#ff00ff','#ffa500','#ffff00','#00ff00','#ffffff','ff00ff']
//END OF MY VARIABLES
...
****************************/
//Code credit to this person ^ but I did edit below the box to make the white sparkles rainbow :P sorry
//Original source code found here: https://www.snazzyspace.com/tumblr/mouse-sparkles.php
//Edits I made are encased in ALL CAPS comments
...
function createDiv(height, width) {
	//THIS IS THE CODE I ADDED TO MAKE IT RAINBOW
	if(cIndex+1 > colors.length){
		cIndex = 0;
	}else{
	  cIndex++;
	}
  colour = colors[cIndex];
  //END OF MY ADDITION
